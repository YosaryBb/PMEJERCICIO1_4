package com.example.pmejercicio1_4;
...
import com.example.pmejercicio1_4.config.SQLiteConexion;
import com.example.pmejercicio1_4.config.Transacciones;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void onClickListActivity(View view) {
        Intent lista = new Intent(getApplicationContext(), com.example.pmejercicio1_4.ActivityLista.class);
        startActivity(lista);
    }
    ...
    private void takePhoto() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            try {
                ...
                if (photoFile != null) {
                    Uri photoURI = FileProvider.getUriForFile(this, "com.example.pmejercicio1_4.fileprovider", photoFile);
